...
void Renderer::LoadObjects(Scene& scene)
{
    ...
    scene.AddObject(device.Get(), "NOPCube/", "cubeN", { -2.0f, 6.0f, 2.0f }, { 0, 0, 0 }, { 0.5, 0.5, 0.5 }, false, false);
    scene.AddObject(device.Get(), "NOPCube/", "cubeD", { 1.0f, 4.0f, 1.0f }, { 0, 0, 0 }, { 0.5, 0.5, 0.5 }, false, false);
