...
void Renderer::LoadObjects(Scene& scene)
{
    ...
    scene.AddObject(device.Get(), "NOPCube/", "cubeN", { -0.2f, 6.0f, 0.2f }, { 0, 0, 0 }, { 0.5, 0.5, 0.5 }, false, false);
    scene.AddObject(device.Get(), "NOPCube/", "cubeD", { 0.1f, 4.0f, 0.1f }, { 0, 0, 0 }, { 0.5, 0.5, 0.5 }, false, false);
